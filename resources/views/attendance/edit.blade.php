                ...
                <div class="card-body p-4">
                    <form action="{{ route('attendance.update', $attendance->id) }}" method="POST">
                                    ...
                                    <div class="row g-4">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group shadow-sm">
                                                        <input type="time" name="break1_out" class="form-control border-end-0 bg-white" value="{{ old('break1_out', $attendance->break1_out ? \Carbon\Carbon::parse($attendance->break1_out)->format('H:i') : '') }}">
                                                        <span class="input-group-text bg-white border-start-0 border-end-0 text-muted px-2">to</span>
                                                        <input type="time" name="break1_in" class="form-control border-start-0 bg-white" value="{{ old('break1_in', $attendance->break1_in ? \Carbon\Carbon::parse($attendance->break1_in)->format('H:i') : '') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 border-top pt-3 border-secondary border-opacity-10">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group shadow-sm">
                                                        <input type="time" name="lunch_out" class="form-control border-end-0 bg-white" value="{{ old('lunch_out', $attendance->lunch_out ? \Carbon\Carbon::parse($attendance->lunch_out)->format('H:i') : '') }}">
                                                        <span class="input-group-text bg-white border-start-0 border-end-0 text-muted px-2">to</span>
                                                        <input type="time" name="lunch_in" class="form-control border-start-0 bg-white" value="{{ old('lunch_in', $attendance->lunch_in ? \Carbon\Carbon::parse($attendance->lunch_in)->format('H:i') : '') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 border-top pt-3 border-secondary border-opacity-10">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group shadow-sm">
                                                        <input type="time" name="break2_out" class="form-control border-end-0 bg-white" value="{{ old('break2_out', $attendance->break2_out ? \Carbon\Carbon::parse($attendance->break2_out)->format('H:i') : '') }}">
                                                        <span class="input-group-text bg-white border-start-0 border-end-0 text-muted px-2">to</span>
                                                        <input type="time" name="break2_in" class="form-control border-start-0 bg-white" value="{{ old('break2_in', $attendance->break2_in ? \Carbon\Carbon::parse($attendance->break2_in)->format('H:i') : '') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('attendance.employee.show', ['employee' => $attendance->employee_id]) }}" class="btn btn-light px-4 py-2 text-secondary border">
                                Cancel
                            </a>
                        </div>
                    </form>
